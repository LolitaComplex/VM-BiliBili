 ...
 *
 */
public class BangumiRecommendItem extends ItemViewDelegateImp<Recommend> implements View.OnClickListener {

    public BangumiRecommendItem(Context context) {
        super(context);
    }
    ...
    public void convert(BaseViewHolder holder, Recommend recommend, int position) {
        holder.setOnClickListener(R.id.BangumiRecommendItem_header_more, this);
        holder.setOnClickListener(R.id.BangumiRecommendItem_footer_btn_timeline, this);
        holder.setOnClickListener(R.id.BangumiRecommendItem_footer_btn_index, this);

        GridViewFactoryView cardViewFactory = holder.getView(R.id.BangumiRecommendItem_body_cvf);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.BangumiRecommendItem_header_more:
                ToastUtil.show("番剧更多");
                break;
            case R.id.BangumiRecommendItem_footer_btn_timeline:
                ToastUtil.show("新番放送");
                break;
            case R.id.BangumiRecommendItem_footer_btn_index:
                ToastUtil.show("番剧索引");
                break;
        }
    }
