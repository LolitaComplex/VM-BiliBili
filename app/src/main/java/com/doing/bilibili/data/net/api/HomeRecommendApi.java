...
public interface HomeRecommendApi {
    ...
    @GET("x/show/old")
    Observable<String> getRecommendedListString(@QueryMap Map<String, String> params);
...
*/
    @GET("x/banner")
    Observable<String> getRecommendedBannerString(@QueryMap Map<String, String> params);

    @GET("x/banner")
    Observable<Response<List<BannerRecommand>>> getRecommendedBanner(@QueryMap Map<String, String> params);
